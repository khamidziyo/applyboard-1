...
{
    global $wpdb;
    $sql = "select a.*,a.created_at as created_on,a.status as app_status,l.name as u_l_name,u.*,u.image as u_image,type.name as type_name,category.name as category_name,cntry.name as cntry_name,grade.name as
